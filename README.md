...
## Overview
This project implements a classic **Ping Pong (Pong) game** on the **FPGA development board Basys 3 Master (Artix-7)** using **Vivado**. The game is written in **Verilog/VHDL** and runs entirely in hardware. The video output is displayed on a **7-segment display**, and the paddles are controlled using buttons on the FPGA board.
